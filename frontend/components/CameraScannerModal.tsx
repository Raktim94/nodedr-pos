...
// Restricting to the formats this app actually deals with (product barcodes
// + the QR codes generated by the barcode/QR label tool) makes zxing both
// faster and more accurate per frame than scanning for every format it
// knows about. TRY_HARDER spends more CPU per frame doing a more thorough
// scan — worth it here since this only runs while the modal is open, not
